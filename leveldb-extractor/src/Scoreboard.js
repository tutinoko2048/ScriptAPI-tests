...
class ScoreboardObjective {
    ...
    getParticipants() {
        const allParticipants = this.scoreboard.getParticipants();
        return allParticipants.filter(identity =>  this.data.Scores.value.value.some(p => p.ScoreboardId.value === identity));
    }
    toJSON() {
